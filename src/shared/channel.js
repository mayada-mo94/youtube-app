...
const getChannelData = async function (channelId) {
    if (channelId) {
        const response = await axios.get(`https://www.googleapis.com/youtube/v3/channels?part=brandingSettings,statistics&id=${channelId}&key=AIzaSyAHGAQ2HWZf80MmcfNTsraJ_9HSt_-8ob0`)
        return {
